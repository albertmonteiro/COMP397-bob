...
(function (objects) {
    // CLOUD CLASS ++++++++++++++++++++++++++++++++++++
    var BurningWheel = (function (_super) {
        __extends(BurningWheel, _super);
        // PRIVATE INSTANCE VARIABLES +++++++++++++++++
        // CONSTRUCTOR METHOD +++++++++++++++++++++++++
        function BurningWheel() {
        ...
        BurningWheel.prototype._checkBounds = function (value) {
            if (this.x <= value) {
                // Generate random X coordinate
                var temp = Math.floor((Math.random() * 1000) + 1);
                this._reset(this._rightBounds + temp);
        ...
        BurningWheel.prototype._reset = function (value) {
        ...
        // PUBLIC METHODS ++++++++++++++++++++++++++++++
        BurningWheel.prototype.update = function () {
    ...
    objects.BurningWheel = BurningWheel;
})(objects || (objects = {}));
//# sourceMappingURL=burningWheel.js.map