...
(function (objects) {
    // CLOUD CLASS ++++++++++++++++++++++++++++++++++++
    var BurningWheel4 = (function (_super) {
        __extends(BurningWheel4, _super);
        // PRIVATE INSTANCE VARIABLES +++++++++++++++++
        // CONSTRUCTOR METHOD +++++++++++++++++++++++++
        function BurningWheel4() {
        ...
        BurningWheel4.prototype._checkBounds = function (value) {
            if (this.x <= value) {
                // Generate random X coordinate
                var temp = Math.floor((Math.random() * 1000) + 1);
                this._reset(this._rightBounds + temp);
        ...
        BurningWheel4.prototype._reset = function (value) {
        ...
        // PUBLIC METHODS ++++++++++++++++++++++++++++++
        BurningWheel4.prototype.update = function () {
