...
(function (objects) {
    // CLOUD CLASS ++++++++++++++++++++++++++++++++++++
    var BurningWheel2 = (function (_super) {
        __extends(BurningWheel2, _super);
        // PRIVATE INSTANCE VARIABLES +++++++++++++++++
        // CONSTRUCTOR METHOD +++++++++++++++++++++++++
        function BurningWheel2() {
        ...
        BurningWheel2.prototype._checkBounds = function (value) {
            if (this.x <= value) {
                // Generate random X coordinate
                var temp = Math.floor((Math.random() * 1000) + 1);
                this._reset(this._rightBounds + temp);
        ...
        BurningWheel2.prototype._reset = function (value) {
        ...
        // PUBLIC METHODS ++++++++++++++++++++++++++++++
        BurningWheel2.prototype.update = function () {
            // scroll the car down the screen
            this.x -= this._speed.x;
            this._checkBounds(this._leftBounds - 100);
        };
        return BurningWheel2;
    }(objects.GameObject));
    objects.BurningWheel2 = BurningWheel2;
})(objects || (objects = {}));
//# sourceMappingURL=burningWheel2.js.map